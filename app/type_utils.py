...
def weekyear_to_tuple(week_year:WeekYear) -> tuple[WeekNo, Year]:
...
def weekyear_to_date(week_year:WeekYear) -> date:
...
def taskdate_to_str(task_date:TaskDate, week_year:WeekYear) -> str:
    """
